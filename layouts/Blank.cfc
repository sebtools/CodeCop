...
<!--- <h1><img src="i/shield3.gif" width="49" height="49" alt=""> CodeCop</h1>

<seb:sebMenu LogoutLink="">
	<seb:sebMenuItem label="Home" link="index.cfm">
	<seb:sebMenuItem label="Rules" link="rule-list.cfm">
	<seb:sebMenuItem label="Packages" link="package-list.cfm">
	<seb:sebMenuItem label="Past Reviews" link="review-list.cfm">
	<seb:sebMenuItem label="About" link="about.cfm">
</seb:sebMenu> --->
